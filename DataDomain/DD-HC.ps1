...
##P8HPCZWEGmaZ7/K1
##L8/UAdDXTlaDjofG5iZk2UrtSmElesSXuKaywL2T8e/IqSzPTNpZCXBPtWnMFkS5TPEGXPobiPUeVggnKvwf8Y7lOMqaeYYLhuJbZOiPr7wVMX6Vy7C61gGXrw==
##Kc/BRM3KXhU=
##
##
...
.EXAMPLE
  ...
  .\DD-HC.ps1 -ConfigFile .\config.json
#>
...
Function Get-CleaningStatus
{
    ...
    Status              = $FilesysStatus_updated | out-string
    }
...
Function Get-CleaningSchedule
{
    ...
    Status              = $FilesysSched_Updated | out-string
    }
