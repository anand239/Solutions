...
[xml]$html = $table | select -Property "Items", "IP Address", "Device Name", "Site", "Status", "Model", "Firmware Version", "Hardware Status", "Service Set Status" | sort -Property "IP Address" | convertto-html -Fragment
...
$to =$toval.Remove(0,3)
$to = $to -split (';')
$subject = "$acct - HPE StoreOnce Health Check Summary "
