...
Function Get-CalendarHTML
{
    ...
    New-HTMLTab -Name "$Name" { 
        New-HTMLContent -HeaderText "$HeaderText" -HeaderBackGroundColor "#5F249F"{
            ...
            } -DisableSelect -DisableStateSave -ScrollX -ScrollSizeY 300 -FixedFooter -FreezeColumnsLeft 7
        }
    }
}
        ...
        if($config.GenerateReport.SizeReport -eq "Yes")
        {
            New-HTMLTab -Name 'Size'{
                New-HTMLContent -HeaderText 'Size Calendar Report ( GB )' -HeaderBackGroundColor "#5F249F"{
                    ...
                    } -DisableSelect -DisableStateSave -ScrollX -ScrollSizeY 300 -FixedFooter  -FreezeColumnsLeft 7 -Buttons copyHtml5, excelHtml5, csvHtml5, pageLength, searchBuilder
                }
            }
        }
...
#1. Added 'Object Type' in SIze, Duration, BSR, Jobcounteachclient reports
#2. -FreezeColumnsLeft 7
#3. Check-Access function added
#4. Reportfiles checking added
