...
# 5. "# No objects found." -in $SessionList_CommandOutput
# 6. yyyy-MM-dd to "yyyyMMMdd",$culture
# 7. "yyyyMMMdd",$culture to ToString("yyyy-MM-dd")) -replace "/","-"
# 8. Duration Bug, Montly Summar Bug