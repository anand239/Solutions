...
.DESCRIPTION
  Checks the DiskSpace Error logs for given Sessionid
	
.INPUTS
  Configfile - config.json
   
.NOTES
  Script:         Get-DiskSpaceError
  Author:         Chintalapudi Anand Vardhan  
  Requirements:   Powershell v3.0 , Posh-SSH Module
  Creation Date:  1-Dec-2021
  Modified Date:  1-Dec-2021 
  Remarks      :  

  .History:
        Version Date                       Author                    Description        
        1.0     1-Dec-2021      Chintalapudi Anand Vardhan        Initial Release
