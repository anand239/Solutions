...
.NOTES
  Script:         Get-DSRReport.ps1
  Author:         Chintalapudi Anand Vardhan
  Requirements :  Powershell v5.0
  Creation Date:  18/09/2021
  Modified Date:  18/09/2021 
  Remarks      :  

  .History:
        Version Date            Author                       Description        
        1.0     18/09/2021      Chintalapudi Anand Vardhan   Initial Release
.EXAMPLE
  Script Usage 

  .\Get-DSRReport.ps1 -ConfigFile .\config.json
#>
