...
#Search-Excel -Source 'C:\Users\tmaity\OneDrive - DXC Production\1.UCMS\3. #34344  E2E Metrics Report - Automation  (Scripting & Orchestration - Task Automation)\Raw Files for MAY month\esl_report.8579725_May 2021.xlsx' -SearchText "System Status" | Format-Table

Search-Excel -Source 'C:\Users\achintalapud\OneDrive - DXC Production\Documents\UCMS\Spoorthi\DPA_ScheduledReport_Mail1.csv' -SearchText "onlatf04"