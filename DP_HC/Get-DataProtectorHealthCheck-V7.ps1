        ...
        $Library_Status_output = @()
            ...
            if($OsType)
            {
                ...
                else
                {
                    ...
                    $DetailReportName = $config.Reportpath +"\"+ $config.Technology + "_"+$config.ReportType+"_"+ $config.backupType +"_"+$config.Account +"_"+$Backupdevice+"_" + "Detailed" + ".txt"
                    ...
                    $DetailedReport | Out-File $DetailReportName
