    ...
    if (Test-Path -Path $config.InputFile)
    {
        ...
        foreach ($BackupDevice in $BackupDevices)
        {
            ...
            if($OsType)
            {
                ...
                {
                    #call Invoke-Command
                    $Dp_Service_Output = Invoke-Command -ComputerName $BackupDevice -Credential $Credential -ScriptBlock {Invoke-Expression $using:config.ServiceHealthCheckCommand}
                    $Backup_Output = Invoke-Command -ComputerName $BackupDevice -Credential $Credential -ScriptBlock {Invoke-Expression $using:config.QueuingBackupHealthCheckCommand}
                    $Disabled_TapeDrive_Output = Invoke-Command -ComputerName $BackupDevice -Credential $Credential -ScriptBlock {Invoke-Expression $using:config.DisabledTapeDriveCountCommand}
                    $Scratch_Media_output = Invoke-Command -ComputerName $BackupDevice -Credential $Credential -ScriptBlock {Invoke-Expression $using:config.ScratchMediaCountCommand}
                }
                else
                {
                    ...
                    $DpService_Report = $Dp_Service_Result | Out-String
                    ...
                    $Queuing30_Report = $Queuing_30_Result| Out-String
                    ...
                    $Queuing_lt24_Report = $Queuing_lt24 | Out-String
                    ...
                    $DisabledTapeDrive_Report = $Disabled_TapeDrive_Result | Out-String
                    ...
                    $ScratchMedia_Report = $Scratch_Media_Result | Out-String
        ...
        $DpService_ReportName = $config.Reportpath +"\"+$config.Account + "_" + $config.Technology + "_" + $config.backupType + "_" + "DpService_Report" + "_" + $Reportdate + ".txt"
        $Queuing30_ReportName = $config.Reportpath +"\"+$config.Account + "_" + $config.Technology + "_" + $config.backupType + "_" + "Queuing30_Report" + "_" + $Reportdate + ".txt"
        $Queuing_lt24_ReportName = $config.Reportpath +"\"+$config.Account + "_" + $config.Technology + "_" + $config.backupType + "_" + "Queuing_lt24_Report" + "_" + $Reportdate + ".txt"
        $Queuing_gt24_ReportName = $config.Reportpath +"\"+$config.Account + "_" + $config.Technology + "_" + $config.backupType + "_" + "Queuing_gt24_Report" + "_" + $Reportdate + ".txt"
        $MountRequest_ReportName = $config.Reportpath +"\"+$config.Account + "_" + $config.Technology + "_" + $config.backupType + "_" + "MountRequest_Report" + "_" + $Reportdate + ".txt"
        $DisabledTapeDrive_ReportName = $config.Reportpath +"\"+$config.Account + "_" + $config.Technology + "_" + $config.backupType + "_" + "DisabledTapeDrive_Report" + "_" + $Reportdate + ".txt"
        $ScratchMedia_ReportName = $config.Reportpath +"\"+$config.Account + "_" + $config.Technology + "_" + $config.backupType + "_" + "ScratchMedia_Report" + "_" + $Reportdate + ".txt"

        $Signalreport | Out-File -Path $SignalReportName 
