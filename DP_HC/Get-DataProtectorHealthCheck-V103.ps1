...
#1. IDB Backup for loop and start time
#2. Free DiskSpace windows command change
#3. Detailed report BackupDevice as BackupServer
#4. Q30M, QG24Hrs,..
#5. Critical Backup Status detailed report change
#6. If condition for Detailed reports