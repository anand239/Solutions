...
Function Get-FailedBackup
{
    ...
    if( "# No sessions matching the search criteria found." -in $InputObject -or $InputObject -eq $null)
    {
        $null
    }
    else
...
Function Get-FreeDiskSpaceHPUX
{
    ...
    for($i=0; $i -lt $FreeDiskSpace_Input.Count ;$i++)
    {
        ...
        if($array.count -eq 6)
        {
            ...
            $obj | Add-Member NoteProperty "BackupServer" $Backupdevice
            $obj | Add-Member NoteProperty "ReportDate" $Reportdate
            $obj | Add-Member NoteProperty "HC_Parameter" "Free Disk Space HPUX"
    ...
    "BackupServer" = $Backupdevice
    "ReportDate" = $Reportdate     
    'HC_Parameter'= "Free Disk Space HPUX"
    "HC_ShortName" = "FDS"
...
Function Get-FreeDiskSpaceUnix
{
    ...
    for($i=0; $i -lt $FreeDiskSpace_Input.Count ;$i++)
    {
        ...
        if($array.count -eq 6)
        {
            ...
            $obj | Add-Member NoteProperty "BackupServer" $Backupdevice
            $obj | Add-Member NoteProperty "ReportDate" $Reportdate
            $obj | Add-Member NoteProperty "HC_Parameter" "Free Disk Space UNIX"
            $obj | Add-Member NoteProperty "Mount Point" $array[5]
...
Function Get-FreeDiskSpaceWindows
{
    ...
    foreach($disk in $FreeDiskSpace_Input)
    {
        ...
        $obj | Add-Member NoteProperty "BackupServer" $Backupdevice
        $obj | Add-Member NoteProperty "ReportDate" $Reportdate
        $obj | Add-Member NoteProperty "HC_Parameter" "Free Disk Space OS Disk"
    ...
    "BackupServer" = $Backupdevice
    "ReportDate" = $Reportdate          
    'HC_Parameter'= "Free Disk Space OS Disk"
    "HC_ShortName" = "FDS"
    "Value"= "$FreeDiskSpace/$TotalDiskSpace"
    'Percentage' = "$percent%"
    'Status' = $Signal
...
$Reportdate = Get-Date -Format "dd-MMM-yy"
        ...
        $Library_Status_output = @()
            ...
            if($OsType)
            {
                ...
                else
                {
                    ...
                    $SignalReportName             = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "Signal" + "_" + $config.Account + "_" + $Backupdevice + "_" + $Reportdate  + ".csv"
                                                                                                                                                                                                                                     
                    $DpService_ReportName         = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "SS"     + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    $Queuing30_ReportName         = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "WQB"    + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    $Queuing_lt24_ReportName      = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "LB_12"  + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    $Queuing_gt24_ReportName      = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "LB_24"  + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    $MountRequest_ReportName      = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "MR"     + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    $DisabledTapeDrive_ReportName = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "DTD"    + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    $ScratchMedia_ReportName      = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "SM"     + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    $FailedBackup_ReportName      = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "FB"     + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    $IDBBackup_ReportName         = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "IDB"    + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    $CriticalBackup_ReportName    = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "CB"     + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    $LibraryStatus_ReportName     = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "LS"     + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    $HungBackup_ReportName        = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "HB"     + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    $DisabledBackupJob_ReportName = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "DB"     + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    $FreeDiskSpace_ReportName     = $config.Reportpath + "\" + $config.Technology + "_" + $config.ReportType + "_" + $config.BackupApplication + "_" + "FDS"    + "_" + $config.Account + "_" + $Backupdevice + "_" + $date  + ".csv"
                    ...
                    else
                    {
                        ...
                        $Queuing30_Result        | Export-Csv -Path $Queuing30_ReportName         -NoTypeInformation
                    }
                    ...
                    else
                    {
                        ...
                        $Queuing12_Result      | Export-Csv -Path $Queuing_lt24_ReportName      -NoTypeInformation
                    }
                    ...
                    else
                    {
                        ...
                        $Queuing24_Result      | Export-Csv -Path $Queuing_gt24_ReportName      -NoTypeInformation
                    }
                    ...
                    else
                    {
                        ...
                        $MountRequest_Result     | Export-Csv -Path $MountRequest_ReportName      -NoTypeInformation
                    }
                    ...
                    else
                    {
                        ...
                        $DisabledTapeDrive_Result| Export-Csv -Path $DisabledTapeDrive_ReportName -NoTypeInformation
                    }
                    ...
                    else
                    {
                        ...
                        $ScratchMedia_Result     | Export-Csv -Path $ScratchMedia_ReportName      -NoTypeInformation
                    }
                    ...
                    else
                    {
                        ...
                        $FailedBackup_result        | Export-Csv -Path $FailedBackup_ReportName      -NoTypeInformation
                    }
                    ...
                    else
                    {
                        ...
                        $CriticalBackup_result      | Export-Csv -Path $CriticalBackup_ReportName    -NoTypeInformation
                    }
...
#1. HungBackup command from config file
#2. IDB Backup  command from config file
#3. LibraryStatus local command from config file