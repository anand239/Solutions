...
Function Get-IDBBackup
{
    ...
    $obj | Add-Member NoteProperty "Name" "IDB Backup Status"
...
Function Get-HungObject
{
    ...
    $HUNG_Object = @()
    for($i=0;$i -le $InputObject.Count;$i+=13)
    {
            $obj = New-Object psObject
...
Function Get-FreeDiskSpaceHPUX
{
    ...
    for($i=0; $i -lt $FreeDiskSpace_Input.Count ;$i++)
    {
        ...
        if($array.count -eq 6)
        {
            ...
            $obj | Add-Member NoteProperty "Account" $config.Account
            $obj | Add-Member NoteProperty "BackupDevice" $Backupdevice
            $obj | Add-Member NoteProperty "Name" "Free Disk Space HPUX"
...
Function Get-FreeDiskSpaceUnix
{
    ...
    for($i=0; $i -lt $FreeDiskSpace_Input.Count ;$i++)
    {
        ...
        if($array.count -eq 6)
        {
            ...
            $obj | Add-Member NoteProperty "Account" $config.Account
            $obj | Add-Member NoteProperty "BackupDevice" $Backupdevice
            $obj | Add-Member NoteProperty "Name" "Free Disk Space UNIX"
...
Function Get-FreeDiskSpaceWindows
{
    ...
    foreach($disk in $FreeDiskSpace_Input)
    {
        ...
        $obj | Add-Member NoteProperty "Account" $config.Account
        $obj | Add-Member NoteProperty "BackupDevice" $Backupdevice
        $obj | Add-Member NoteProperty "Name" "Free Disk Space OS Disk"
        $FreeDiskSpace_Result += $obj
    }
    $TotalDiskSpace = ($FreeDiskSpace_Result | Measure-Object -Property 'Total Size(GB)' -Sum).Sum
    $FreeDiskSpace = ($FreeDiskSpace_Result | Measure-Object -Property 'Free Space(GB)' -Sum).Sum
            ...
            if($OsType)
            {
                ...
                if($OsType -eq "Windows")
                {
                    ...
                    if($failedBackup_Output)
                    {
                        ...
                        if($IDBBackUp.Status -eq "completed")
                        {
                            ...
                            $IDB_Backup_Result = Get-IDBBackup -InputObject $CommandOutput_IDB
                            $IDBSuccess_Count = 1
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    if($failedBackup_Output)
                    {
                        ...
                        {
                            $command_IDB = "omnidb -session $($IDBBackUp.'Session Id') -media"
                            $CommandOutput = Invoke-BackupHealthCheckCommand -SshSessionId $sshsessionId -logFile $Activitylog -command $command_IDB
                    ...
                    $DpService_ReportName         = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-SS"   +".csv"
                    $Queuing30_ReportName         = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-Q30"  +".csv"
                    $Queuing_lt24_ReportName      = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-QL24" +".csv"
                    $Queuing_gt24_ReportName      = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-QG24" +".csv"
                    $MountRequest_ReportName      = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-MR"   +".csv"
                    $DisabledTapeDrive_ReportName = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-DTD"  +".csv"
                    $ScratchMedia_ReportName      = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-SM"   +".csv"
                    $FailedBackup_ReportName      = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-FB"   +".csv"
                    $IDBBackup_ReportName         = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-IDB"  +".csv"
                    $CriticalBackup_ReportName    = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-CB"   +".csv"
                    $LibraryStatus_ReportName     = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-LB"   +".csv"
                    $HungBackup_ReportName        = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-HB"   +".csv"
                    $DisabledBackupJob_ReportName = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-DB"   +".csv"
                    $FreeDiskSpace_ReportName     = $config.Reportpath +"\"+ $config.ReportType + "_" + $config.Backuptype + "_" + $config.Account + "_" + $Backupdevice +"_" + "HC-FDS"  +".csv"
