    ...
    #{
        ...
        $Library_Status_output = @()
            ...
            else
            {
                ...
                $SignalReport += New-SignalObject @SignalHash

                $signalHash.HC_Parameter = "Queuing Backup Count(>30 min)"
                $signalHash.HC_ShortName = "WQB"
                $SignalReport += New-SignalObject @SignalHash

                $signalHash.HC_Parameter = "Long Running Backup Count(>12 Hr and <24 Hr)"
                $signalHash.HC_ShortName = "LB_12"
                $SignalReport += New-SignalObject @SignalHash

                $signalHash.HC_Parameter = "Long Running Backup Count(>24 Hr)"
                $signalHash.HC_ShortName = "LB_24"
                $SignalReport += New-SignalObject @SignalHash

                $signalHash.HC_Parameter = "Mount Request"
                $signalHash.HC_ShortName = "MR"
                $SignalReport += New-SignalObject @SignalHash

                $signalHash.HC_Parameter = "Disabled Tape Drive Count"
                $signalHash.HC_ShortName = "DTD"
                $SignalReport += New-SignalObject @SignalHash

                $signalHash.HC_Parameter = "Scratch Media Count"
                $signalHash.HC_ShortName = "SM"
                $SignalReport += New-SignalObject @SignalHash

                $signalHash.HC_Parameter = "Failed Backup Count"
                $signalHash.HC_ShortName = "FB"
                $SignalReport += New-SignalObject @SignalHash

                $signalHash.HC_Parameter = "IDB Backup Status"
                $signalHash.HC_ShortName = "IDB"
                $SignalReport += New-SignalObject @SignalHash

                $signalHash.HC_Parameter = "Critical Backup Status"
                $signalHash.HC_ShortName = "CB"
                $SignalReport += New-SignalObject @SignalHash

                $signalHash.HC_Parameter = "Library Status"
                $signalHash.HC_ShortName = "LB"
                $SignalReport += New-SignalObject @SignalHash

                $signalHash.HC_Parameter = "Hung Backup Count"
                $signalHash.HC_ShortName = "HB"
                $SignalReport += New-SignalObject @SignalHash

                $signalHash.HC_Parameter = "Disabled Backup Job Count"
                $signalHash.HC_ShortName = "DB"
                $SignalReport += New-SignalObject @SignalHash

                $signalHash.HC_Parameter = "Free Disk Space"
                $signalHash.HC_ShortName = "FDS"
                $SignalReport += New-SignalObject @SignalHash
